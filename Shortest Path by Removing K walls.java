gfg link => https://practice.geeksforgeeks.org/problems/shortest-path-by-removing-k-walls/1

//QUES: Given a 2-D binary matrix of size n*m, where 0 represents an empty space while 1 represents a wall you cannot walk through. You are also given an integer k.
...
// Your Task:
// The task is to complete the function shotestPath() which takes three integers n, m, and k and also a matrix of size n*m as input and returns the minimum number of 
//steps to walk from the top left corner to the bottom right corner.
