gfg link=> https://practice.geeksforgeeks.org/problems/maximum-sum-lcm3025/1

//QUES: Given a positive number n. You need to write a program to find the maximum sum of distinct numbers such that the LCM of all these numbers is equal to n.
